...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2022 a las 19:26:05
...
INSERT INTO `dedicacion` (`id_dedicacion`, `id_agente`, `mes`, `anio`, `horas`, `imputacion`, `timeStamp`) VALUES
(2, 2, 2, 2, 22, 2, ''),
(3, 33, 2, 2022, 40, 2, ''),
(4, 21, 2, 2022, 22, 2, '');
...
INSERT INTO `proyectos` (`id_proyectos`, `identificador`, `nombre`, `fecha_inicio`, `tema`, `descripcion`, `sector`, `responsable`, `fecha_realizado`, `observaciones`, `estado`, `archivo`, `Tipo`) VALUES
(2, '123', 'loop chf', '2021-02-18', 'compras', 'no tiene', 'labthi', '2', '2021-02-18', 'no tiene', 'Pendiente', NULL, 1),
(5, '1234', 'sistema de gestion', '2021-02-05', 'programacion', 'esto es una descripcion', 'lab thi', '2', '2021-02-25', '', 'Revisar', NULL, 0),
(10, 'lc1', 'loop chico', '2021-02-26', 'varios', 'sin descripción', 'thi', '2', '2021-02-25', 'asd', 'En proceso', NULL, 1),
(13, '412', 'ulti', '2021-02-16', 'asdas', 'asdas', 'asdas', '27', '2021-02-12', 'ASas', 'Cancelado', NULL, 0),
(14, '1234', 'aprobarEfip', '2021-02-23', 'efip', 'efip', 'efip', '2', '2021-02-23', 'Aprovado', 'Realizado', NULL, 1);
