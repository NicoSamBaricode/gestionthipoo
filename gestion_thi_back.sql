...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2022 a las 17:35:29
...
--
-- Base de datos: `gestion_thi_back`
--
...
(1, '123a', 'prueba2a', 'actividad1a', 13, '#000000'),
...
CREATE TABLE `dedicacion` (
  ...
  `horas_relevadas` int(11) NOT NULL,
  `imputacion` int(11) NOT NULL,
...
INSERT INTO `dedicacion` (`id_dedicacion`, `id_agente`, `mes`, `anio`, `horas`, `horas_relevadas`, `imputacion`, `timeStamp`, `obs`) VALUES
(3, 21, 3, 2022, 12, 12, 5, '2022-03-21 13:31:54', 'asd'),
(4, 33, 3, 2022, 123, 0, 13, '2022-03-21 13:32:09', 'as');
...
INSERT INTO `mes` (`id_Mes`, `nombre`, `horas_Totales`) VALUES
(1, 'Enero', 168),
(2, 'Febrero', 144),
(3, 'Marzo', 144),
(4, 'Abril', 144),
...
INSERT INTO `proyectos` (`id_proyectos`, `identificador`, `nombre`, `fecha_inicio`, `tema`, `descripcion`, `sector`, `responsable`, `fecha_realizado`, `observaciones`, `estado`, `archivo`, `Tipo`, `horas_dedicadas`, `color_act`) VALUES
(2, '123', 'loop chf', '2021-02-18', 'compras', 'no tiene', 'labthi', '2', '2021-02-18', 'no tiene', 'Pendiente', NULL, 1, 1, '#2a67c9'),
(5, '1234', 'sistema de gestion', '2021-02-05', 'programacion', 'esto es una descripcion', 'lab thi', '2', '2021-02-25', '', 'Revisar', NULL, 0, 12, '#2a81c9'),
(10, 'lc1', 'loop chico', '2021-02-26', 'varios', 'sin descripción', 'thi', '2', '2021-02-25', 'asd', 'En proceso', NULL, 1, 2, 'red'),
(13, '412', 'ulti', '2021-02-16', 'asdas', 'asdas', 'asdas', '27', '2021-02-12', 'ASas', 'Cancelado', NULL, 0, 122, 'blue'),
(14, '1234', 'aprobarEfip', '2021-02-23', 'efip', 'efip', 'efip', '2', '2021-02-23', 'Aprobado', 'Realizado', NULL, 1, 3, 'green'),
(17, '123Actividad', 'Prueba Actividad', '0000-00-00', '', 'Prueba Loca', '', '', '0000-00-00', '', '', NULL, 0, 22, 'black'),
(18, '123Actividad', 'Prueba2Actividades', '0000-00-00', '', 'DescripcionActividad', '', '', '0000-00-00', '', '', NULL, 0, 21, 'orange'),
(19, '123Actividad', 'Prueba2Actividades', '0000-00-00', '', 'DescripcionActividad', '', '', '0000-00-00', '', '', NULL, 0, 21, '#2a51c9');
...
(16, 'elicitacion', 'adas', '22', '2021-02-04', '2021-02-24', 'Pendiente', '10');
...
(33, 'Dario', 'Osorio', 'dariooon@gmail.com', 'Dario.O', 'Admin', '123', NULL);
...
--
ALTER TABLE `proyectos`
  MODIFY `id_proyectos` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `tareas`
--
ALTER TABLE `tareas`
  MODIFY `id_tareas` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
